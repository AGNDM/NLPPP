...
: "${EXTRA_ENV:=/iopsstor/scratch/cscs/tong/share/xianrong_liu/cache_env_setup.sh}"


HF_TOKEN=""  # Replace with your actual token or export HF_TOKEN before sbatch
...
srun --uenv="${UENV_IMAGE}" --view="default" bash -c "\
